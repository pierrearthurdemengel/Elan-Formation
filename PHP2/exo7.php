...
<form>
    <div>
        <?php
$elements = array("Choix1", "Choix2", "Choix3");
...
echo "<table>" . "<tr><th>".$elements."</th><th>Coché</th>
</tr></br>";
...
echo "<input type='checkbox' name='choix[]' value=$valeur>
<label>$valeur</label>";
        if(isset($_POST[$valeur])) {
            if(!empty($_POST[$valeur])) {
                foreach($_POST[$valeur] as $value) {
                    echo $value." choisie<br/>";
                }
            }
        }
